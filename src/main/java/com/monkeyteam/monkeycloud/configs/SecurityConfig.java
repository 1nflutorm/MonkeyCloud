...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/downloadFile").hasAnyRole("USER", "ADMIN")
                .antMatchers("/deleteFile").hasAnyRole("USER", "ADMIN")
                .antMatchers("/renameFile").hasAnyRole("USER", "ADMIN")
                .antMatchers("/addToFavorite").hasRole("USER")
                .antMatchers("/removeFromFavorite").hasRole("USER")
                .antMatchers("/uploadFolder").hasRole("USER")
                .antMatchers("/deleteFolder").hasAnyRole("USER", "ADMIN")
                .antMatchers("/renameFolder").hasAnyRole("USER", "ADMIN")
